...
$dao=new DataAccess();
$elements=array(
        'fname'=>'','lname'=>'','phone'=>'','email'=>'','password'=>'','cpassword'=>'');


$form=new FormAssist($elements,$_POST);
//$file=new FileUpload();
$labels=array('fname'=>"First Name","lname"=>"Last Name","phone"=>"Phone Number","email"=>"Email Id","password"=>"Password","cpassword"=>"Confirm Password");
...
$rules=array(
    ...
    "password"=>array("required"=>true,"minlength"=>3,"maxlength"=>8),

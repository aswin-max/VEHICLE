...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Nov 05, 2023 at 07:45 PM
...
INSERT INTO `payment` (`payid`, `pid`, `amount`, `pdate`, `invid`) VALUES
(10, 6, 500, '2023-11-05', 'C2AUP22ADGAU'),
(11, 6, 500, '2023-11-05', 'WFV89MJY0QSF');
...
INSERT INTO `payment1` (`payid`, `pid`, `invid`, `amount`, `pdate`) VALUES
(1, 6, 'L3S973I1XXN6', 500, '2023-11-05');
...
('2023-10-24', 2, 'Wayanad', 'Richards', 5, 1, 5),
('2023-10-10', 1, 'Varkala', 'Rivers', 6, 2, 2);
...
INSERT INTO `vehicle` (`tid`, `rid`, `vid`, `vrno`, `vehiclename`, `fid`, `color`, `dor`, `rc`, `status`) VALUES
